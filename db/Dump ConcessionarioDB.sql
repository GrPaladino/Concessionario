...
INSERT INTO `automobile_motore` VALUES (1,2,8),(2,4,4),(3,6,5),(4,7,6),(5,9,1),(6,11,2),(7,1,4),(8,20,2),(9,1,3),(10,3,6),(11,9,7),(12,7,8),(13,5,1),(14,4,2),(15,4,6),(16,6,5),(17,8,3),(18,9,7),(19,17,8),(21,12,1),(22,14,2),(23,13,4),(24,17,5),(25,19,7),(26,20,8),(27,18,5),(28,5,3),(29,16,5),(30,15,7),(31,12,1),(32,14,5),(33,6,7),(34,8,2),(35,3,8),(36,1,7),(37,6,3);
...
CREATE TABLE `automobili` (
  ...
  PRIMARY KEY (`id`),
  KEY `concessionario_id` (`concessionario_id`),
  KEY `cliente_id` (`cliente_id`),
  CONSTRAINT `automobili_ibfk_1` FOREIGN KEY (`concessionario_id`) REFERENCES `concessionari` (`id`),
...
INSERT INTO `concessionari` VALUES (1,'Autoland','Via degli abeti 21, 70100 BARI','DH715682C3R'),(2,'Autolandprova','Via degli abeti 21, 70100 BARI','DH731115H3R');
...
INSERT INTO `motori` VALUES (1,70,1,'metano'),(2,140,2,'diesel'),(3,136,2.2,'benzina'),(4,250,2.5,'ibrido'),(5,50,1,'gpl'),(6,90,1.2,'metano'),(7,170,2,'diesiel'),(8,400,3,'benzina'),(9,240,3.2,'benzina'),(11,140,2,'diesdfsfsel'),(12,140,2,'sel'),(13,140,2,'semsmsl');
...
-- Dump completed on 2024-10-03 15:55:44
